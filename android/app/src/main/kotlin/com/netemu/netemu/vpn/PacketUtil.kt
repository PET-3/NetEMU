...
object PacketUtil {
    ...
    /** Build IPv4 + UDP packet for injecting into TUN (server -> client direction). */
    fun buildUdpPacket(
        src: InetAddress,
        dst: InetAddress,
        srcPort: Int,
    ...
    /** Build IPv4 + TCP packet (simplified, for ACK/data injection). */
    fun buildTcpPacket(
        src: InetAddress,
        dst: InetAddress,
        srcPort: Int,
        ...
        buf[t + 12] = 0x50.toByte() // header len 5 words
